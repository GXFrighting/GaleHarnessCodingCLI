...
2. For each changed file, check its ancestor directories up to the repo root for standards files. A file like `plugins/galeharness-cli/AGENTS.md` applies to all changes under `plugins/galeharness-cli/`.
